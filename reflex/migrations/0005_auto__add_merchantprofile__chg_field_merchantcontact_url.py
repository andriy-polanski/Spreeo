...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MerchantProfile'
        db.create_table(u'reflex_merchantprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('merchant', self.gf('django.db.models.fields.related.OneToOneField')(related_name='merchant_profile', unique=True, to=orm['reflex.Merchant'])),
            ('company_name', self.gf('django.db.models.fields.CharField')(max_length=120, db_index=True)),
            ('company_short_description', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('company_description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('company_registration_no', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
        ...
        db.send_create_signal(u'reflex', ['MerchantProfile'])


        # Changing field 'MerchantContact.url'
        db.alter_column(u'reflex_merchantcontact', 'url', self.gf('django.db.models.fields.URLField')(max_length=255))

    def backwards(self, orm):
        # Deleting model 'MerchantProfile'
        db.delete_table(u'reflex_merchantprofile')


        # Changing field 'MerchantContact.url'
        db.alter_column(u'reflex_merchantcontact', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'reflex.merchantcontact': {
            ...
            'city_town': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'reflex.merchantprofile': {
            'Meta': {'object_name': 'MerchantProfile'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reflex.TopLevelCategory']", 'null': 'True', 'blank': 'True'}),
            'company_description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'company_name': ('django.db.models.fields.CharField', [], {'max_length': '120', 'db_index': 'True'}),
            'company_registration_no': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'company_short_description': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'merchant': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'merchant_profile'", 'unique': 'True', 'to': u"orm['reflex.Merchant']"}),
