...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MerchantContact.label'
        db.add_column(u'reflex_merchantcontact', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'MerchantContact.city_town'
        db.add_column(u'reflex_merchantcontact', 'city_town',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MerchantContact.label'
        db.delete_column(u'reflex_merchantcontact', 'label')

        # Deleting field 'MerchantContact.city_town'
        db.delete_column(u'reflex_merchantcontact', 'city_town')
