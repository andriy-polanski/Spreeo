...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreLevelCategory.path'
        db.add_column(u'reflex_storelevelcategory', 'path',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreLevelCategory.path'
        db.delete_column(u'reflex_storelevelcategory', 'path')
