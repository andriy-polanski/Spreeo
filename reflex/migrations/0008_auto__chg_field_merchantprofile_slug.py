...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MerchantProfile.slug'
        db.alter_column(u'reflex_merchantprofile', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'MerchantProfile.slug'
        db.alter_column(u'reflex_merchantprofile', 'slug', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'reflex.merchantshippingoption': {
            ...
            'shipping_region': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'reflex.storelevelcategory': {
            ...
            'path': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
