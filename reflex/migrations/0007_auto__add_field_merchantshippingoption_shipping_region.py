...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MerchantShippingOption.shipping_region'
        db.add_column(u'reflex_merchantshippingoption', 'shipping_region',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MerchantShippingOption.shipping_region'
        db.delete_column(u'reflex_merchantshippingoption', 'shipping_region')
